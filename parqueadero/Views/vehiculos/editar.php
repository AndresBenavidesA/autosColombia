...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value=<?php echo $usuarios->cedula; ?> name="cedula" aria-describedby="helpId" placeholder="Cédula" required>
            </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="" id="" class="btn btn-success" type="submit" value="Cambiar Usuario">
        </form>
    </div>
</div>